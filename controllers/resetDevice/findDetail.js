...
exports.findDetailResetDeviceId = void 0;
...
const findDetailResetDeviceId = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(resetDeciceSchema_1.findDetailResetDeviceSchema, req.params);
    if (error != null) {
    ...
    try {
        const result = await resetDeviceModel_1.ResetDeviceModel.findOne({
            where: {
                deleted: 0,
                resetDeviceId: value.resetDeviceId
            }
        });
        if (result == null) {
...
exports.findDetailResetDeviceId = findDetailResetDeviceId;
