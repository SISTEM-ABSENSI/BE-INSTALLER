...
exports.createLocationTracker = void 0;
...
const createLocationTracker = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(reportSchema_1.createRealtimeLocationSchema, req.body);
    if (error != null) {
...
exports.createLocationTracker = createLocationTracker;
