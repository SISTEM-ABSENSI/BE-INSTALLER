...
exports.findAllEmployeeLocationSchema = exports.createEmployeeLocationSchema = exports.updateEmployeeSchema = exports.findDetailEmployeeSchema = exports.findAllEmployeeSchema = void 0;
...
exports.createEmployeeLocationSchema = joi_1.default.object({
    jwtPayload: jwtPayloadSchema_1.jwtPayloadSchema,
    employeeLocationLongitude: joi_1.default.string().required(),
    employeeLocationLatitude: joi_1.default.string().required()
});
exports.findAllEmployeeLocationSchema = joi_1.default.object({
    jwtPayload: jwtPayloadSchema_1.jwtPayloadSchema,
